...
function Set-AzSKPIMConfiguration { 
    ...
    (
        ...
        [Parameter(Mandatory = $false, ParameterSetName = "ConfigureRoleForManagementGroup", HelpMessage = "This switch is required to configure role settings for a role on a resource.")]
        [Alias("crs")]
