...
"        c) If the control status says 'Skipped', it means that you have chosen to skip certain controls using the '-SkipControlsFromFile' parameter.`r`n" 
	...
	static [string] $PolicyMismatchMsgCSE = "Warning: Make sure you have installed AzSK as per steps specified at https://aka.ms/devopskit/onboarding. `nIf onboarding document does not help to resolve the issue, please contact your Org policy Owner ({0})."
