...
$serviceName = Get-VstsInput -Name ADOConnectionName
...
#Load the azsk.ado module into memory
...
try {
    ...
    $ArchiveFileName = "$env:SYSTEM_DEFAULTWORKINGDIRECTORY"+"\AzSKADO_"+$(([System.DateTime]::UtcNow).ToString('hhmmss'))+ "Logs.zip"
